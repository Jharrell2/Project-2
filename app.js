...
function playRound(playerSelection, computerSelection) {
    ...
    // if the player chooses scissors and the computer chooses paper, the player wins
        ...
        winsElement.textContent = wins; // Update the wins element
    ...
    // if the player chooses rock and the computer chooses paper, the player loses
        ...
        lossesElement.textContent = losses; // Update the losses element
...
function handleClick(event) {
    ...
    resultElement.textContent = result; // Display the result of the round
}
